...
namespace IBroStudio\PathSelectPrompt\Themes\Default;

use IBroStudio\PathSelectPrompt\PathSelectPrompt;
use Laravel\Prompts\Themes\Contracts\Scrolling;
use Laravel\Prompts\Themes\Default\Concerns\DrawsBoxes;
use Laravel\Prompts\Themes\Default\Concerns\DrawsScrollbars;
use Laravel\Prompts\Themes\Default\Renderer;

class PathSelectPromptRenderer extends Renderer implements Scrolling
{
    use DrawsBoxes;
    use DrawsScrollbars;
     ...
     */
    public function __invoke(PathSelectPrompt $prompt): string
    {
        ...
        return match ($prompt->state) {
            'submit' => $this
                ->box(
                    ...
                    $this->truncate((string) $prompt->label(), $maxWidth),
                ),
     ...
     * Render the options.
     */
    protected function renderOptions(PathSelectPrompt $prompt): string
    {
